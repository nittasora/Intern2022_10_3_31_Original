...
namespace MySystem
{
	...
	private:
		...
		Transform*			_pParent;	//!< 親
		Array<Transform*>	_paChildren;	//!< 子供達
	...
	public:
		 ...
		 * @param[in] pParent	親
		 **************************************************************************************************** */
		Transform(const Position& position, const Scale& scale, const Angle& angle, Transform* pParent) noexcept;
		 ...
		 * @param[in] parent	親
		 **************************************************************************************************** */
		void SetParent(Transform* pParent) noexcept;

		/** ****************************************************************************************************
		 * @brief				子供設定
		 * @param[in] parent	子供
		 **************************************************************************************************** */
		void SetChild(Transform* pChild) noexcept;
		 ...
		 **************************************************************************************************** */
		void SetWorlPosition(const Position& position) noexcept;

		/** ****************************************************************************************************
		 * @brief			ワールドスケールからローカルの大きさ変更
		 * @param[in] scale	ワールドスケール
		 **************************************************************************************************** */
		void SetWorlScale(const Scale& scale) noexcept;

		/** ****************************************************************************************************
		 * @brief			ワールドアングルからローカルの角度変更
		 * @param[in] scale	ワールドアングル
		 **************************************************************************************************** */
		void SetWorlAngle(const Angle& angle) noexcept;
		 ...
		 * @return	ワールド座標
		 **************************************************************************************************** */
		Position GetWorlPosition() const noexcept;

		/** ****************************************************************************************************
		 * @brief	ワールドスケール取得
		 * @return	ワールドスケール
		 **************************************************************************************************** */
		Scale GetWorlScale() const noexcept;

		/** ****************************************************************************************************
		 * @brief	ワールドアングル取得
		 * @return	ワールドアングル
		 **************************************************************************************************** */
		Angle GetWorlAngle() const noexcept;
	};
}
