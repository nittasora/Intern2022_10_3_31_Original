...
namespace MySystem::GimmickData
{
	Gimmick::Gimmick()
	{
		...
		TextureAsset::Register(gLABEL_SIMPLE_TEXTURE[static_cast<TypeIndex>(Type::Player)], U"👤"_emoji);
		TextureAsset::Register(gLABEL_SIMPLE_TEXTURE[static_cast<TypeIndex>(Type::Goal)], U"🚩"_emoji);
		TextureAsset::Register(gLABEL_SIMPLE_TEXTURE[static_cast<TypeIndex>(Type::Max)], U"✖"_emoji);
	}
